...
<div class="container">
  ...
  <section id="contentSection">
      ...
      <div class="col-lg-8 col-md-8 col-sm-8">
        <div class="left_content">
          <div class="contact_area">
            <h2>Contact Us</h2>
            <p>For any news, information, notice, celebration, events, latest report, eyewitnesses and/or incident whatsoever please feel free to contact us, your information is safe with us.</p>
	...
	$mmysql_query = mysql_query("INSERT INTO message (name, email, msg) VALUES ('$name','$email','$message')");
	if($mmysql_query == true){
		echo 'Message Sent Successfully';
	}
	else
	{
		echo'Error:'. mysql_error(mysql_query);
	}
	}
